...
public class ServiceImplementations implements AppServices{
    ...
    public ServiceImplementations() {
        list = new ArrayList<>();
        list.add(new AppEntities(101,"Spring Framework","Pradeep"));
        list.add(new AppEntities(102,"Spring Boot","David"));
        list.add(new AppEntities(103,"Webb Applications","Adam"));
